                                    ...
                                    while Extract1!=1:
                                            ...
                                            if i==1:
                                                ...
                                                if int(INFO,2)<=Number_of_the_file and File_information6_times2_1==Times_12:
                                                       ...
                                                       Time_Real3=format(NM1,C)
                                                       T1=len(Time_Real3)
                                                   
                                                       Time_Real1=bin(T1)[2:]
                                                       T2=len(Time_Real1)
                                                       Time_Real4=format(T2,'06b')
                                                       NM2=Time_Real4+Time_Real1+Time_Real3
                                                       ...
                                                       if int(INFO,2)<=Number_of_the_file and File_information6_times2_1==Times_12:
                                                               ...
                                                               File_information5_17="1"+XN+Counts+long_file+NM2
                                                               lenf=len(File_information5_17)
                                                               add_bits=""
                                                               count_bits=8-lenf%8
                                                               z=0
                                ...
                                if i==2:
                                    ...
                                    if C==1:
                                        ...
                                        if   File_information6_times2==0:
                                                ...
                                                Real_C1=int(File_information5[:Real_C],2)
                                                File_information5=File_information5[Real_C:]
                                                Number_plus=int(File_information5[:Real_C1],2)
                                            ...
                                            if i==2:
                                                ...
                                                if Extract_info==counts and File_information6_times2_1==Times_12 and X1==XR:
                                                       ...
                                                       if Extract_info==counts and File_information6_times2_1==Times_12 and X1==XR:
                                                               ...
                                                               CN="0"+str(long)+"b"
                                                               Number_of_the_file-=Number_plus
